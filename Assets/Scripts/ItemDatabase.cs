...
public class ItemDatabase : MonoBehaviour {
	...
	void Start(){
		...
		items.Add(new Item("noise alarm",6,"A noise alarm.",new List<int>(new int[]{0,1,7}),Item.ItemType.FORTIFICATION));		items.Add(new Item("rope",7,"Some rope.",Item.ItemType.MATERIAL));
